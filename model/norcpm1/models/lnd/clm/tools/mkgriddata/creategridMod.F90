...
!-----------------------------------------------------------------------
    ...
    str = &
'$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/cesm1_0_4_rel_tags/cesm1_0_4_n04_clm4_0_32/models/lnd/clm/tools/mkgriddata/creategridMod.F90 $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
