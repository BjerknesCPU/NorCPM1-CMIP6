...
!---------------------------------------------------------------------------
    ...
    do g = begg,endg
       ...
       l2x_l%rAttr(index_l2x_Sl_uas,i)      = -l2a%u_ref10m(g) &
         * l2a%taux(g) / max(1e-20, sqrt ( &
         l2a%taux(g)**2 + l2a%tauy(g)**2 ))
       l2x_l%rAttr(index_l2x_Sl_vas,i)      = -l2a%u_ref10m(g) &
         * l2a%tauy(g) / max(1e-20, sqrt ( &
         l2a%taux(g)**2 + l2a%tauy(g)**2 ))
