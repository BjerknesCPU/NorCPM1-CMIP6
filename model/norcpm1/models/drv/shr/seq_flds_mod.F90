...
subroutine seq_flds_set()
   ...
   seq_flds_x2a_states = &
      ...
      //':Sl_ram1'     &    !                                 DEF
      //':Sx_u10'      &    ! 10m wind                        DEF
      //':Sx_uas'      &    ! 10m wind - u component          DEF 
      //':Sx_vas'           ! 10m wind - v component          DEF 
   ...
   seq_flds_i2x_states = &
      ...
      //':Si_u10'      &    ! 10m wind                        DEF   
      //':Si_uas'      &    ! 10m wind - u component          DEF 
      //':Si_vas'           ! 10m wind - v component          DEF 
   ...
   ! States
    seq_flds_l2x_states = &
      ...
      //':Sl_u10'      &    ! 10m wind                        DEF
      //':Sl_uas'      &    ! 10m wind - u component          DEF
      //':Sl_vas'           ! 10m wind - v component          DEF
   ...
   ! States
    ...
    seq_flds_xao_states = &
      ...
      //':So_uas'      &    ! state: 10m wind speed u comp    DEF 
      //':So_vas'           ! state: 10m wind speed v comp    DEF 
...
!   lookup(243,2) = ''
    ...
    lookup(248,1) = 'Si_uas'
    lookup(248,2) = 'Sea ice 10m eastward wind'
    lookup(248,3) = 'Sea_ice_10m_eastward_wind'
    lookup(248,4) = 'm'

    lookup(249,1) = 'Sl_uas'
    lookup(249,2) = 'Land 10m eastward wind'
    lookup(249,3) = 'Land_10m_eastward_wind'
    lookup(249,4) = 'm'

    lookup(250,1) = 'So_uas'
    lookup(250,2) = 'Ocean 10m eastward wind'
    lookup(250,3) = 'Ocean_10m_eastward_wind'
    lookup(250,4) = 'm'

    lookup(251,1) = 'Sx_uas'
    lookup(251,2) = 'Merged 10m eastward wind'
    lookup(251,3) = 'Merged_10m_eastward_wind'
    lookup(251,4) = 'm'

    lookup(252,1) = 'Si_vas'
    lookup(252,2) = 'Sea ice 10m northward wind'
    lookup(252,3) = 'Sea_ice_10m_northward_wind'
    lookup(252,4) = 'm'

    lookup(253,1) = 'Sl_vas'
    lookup(253,2) = 'Land 10m northward wind'
    lookup(253,3) = 'Land_10m_northward_wind'
    lookup(253,4) = 'm'

    lookup(254,1) = 'So_vas'
    lookup(254,2) = 'Ocean 10m northward wind'
    lookup(254,3) = 'Ocean_10m_northward_wind'
    lookup(254,4) = 'm'

    lookup(255,1) = 'Sx_vas'
    lookup(255,2) = 'Merged 10m northward wind'
    lookup(255,3) = 'Merged_10m_northward_wind'
    lookup(255,4) = 'm'
