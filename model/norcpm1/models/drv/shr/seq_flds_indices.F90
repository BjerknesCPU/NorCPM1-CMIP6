...
! !PUBLIC TYPES:
  ...
  integer :: index_x2a_Sx_uas          ! 10m wind - u component
  integer :: index_x2a_Sx_vas          ! 10m wind - v component
  !
  ...
  integer :: index_i2x_Si_uas          ! 10m wind - u component
  integer :: index_i2x_Si_vas          ! 10m wind - v component
  ...
  integer :: index_l2x_Sl_uas          ! 10m wind - u component
  integer :: index_l2x_Sl_vas          ! 10m wind - v component
...
!-------------------------------------------------------------------------------
    ...
    index_x2a_Sx_uas       = shr_string_listGetIndexF(seq_flds_x2a_fields,'Sx_uas')
    if (index_x2a_Sx_uas == 0) call shr_sys_abort('index_x2a_Sx_uas is zero')

    index_x2a_Sx_vas       = shr_string_listGetIndexF(seq_flds_x2a_fields,'Sx_vas')
    if (index_x2a_Sx_vas == 0) call shr_sys_abort('index_x2a_Sx_vas is zero')
   ...
   ! dry deposition velocities
    ...
    index_xao_So_uas         = shr_string_listGetIndexF(seq_flds_xao_fields,'So_uas')
    if (index_xao_So_uas == 0) call shr_sys_abort('index_xao_So_uas is zero')

    index_xao_So_vas         = shr_string_listGetIndexF(seq_flds_xao_fields,'So_vas')
    if (index_xao_So_vas == 0) call shr_sys_abort('index_xao_So_vas is zero')
    ...
    index_i2x_Si_uas       = shr_string_listGetIndexF(seq_flds_i2x_fields,'Si_uas')
    if (index_i2x_Si_uas == 0) call shr_sys_abort('index_i2x_Si_uas is zero')

    index_i2x_Si_vas       = shr_string_listGetIndexF(seq_flds_i2x_fields,'Si_vas')
    if (index_i2x_Si_vas == 0) call shr_sys_abort('index_i2x_Si_vas is zero')
    ...
    index_l2x_Sl_uas        = shr_string_listGetIndexF(seq_flds_l2x_fields,'Sl_uas')
    if (index_l2x_Sl_uas == 0) call shr_sys_abort('index_l2x_Sl_uas is zero')

    index_l2x_Sl_vas        = shr_string_listGetIndexF(seq_flds_l2x_fields,'Sl_vas')
    if (index_l2x_Sl_vas == 0) call shr_sys_abort('index_l2x_Sl_vas is zero')
