...
!-----------------------------------------------------------------------
      ...
      subroutine aurora_register
        ...
        call pbuf_add('AurIPRateSum' , 'physpkg', 1,pver,1, indxAIPRS)     ! Sum of ion auroral production rates for O2
...
!-----------------------------------------------------------------------
	 ...
	 if( pref_mid(k) >= plb ) then
      ...
      write(iulog,*) ' '
      write(iulog,*) 'aurora_inti: aurora will go down to lev,p = ',lev1,pref_mid(lev1)
      write(iulog,*) ' '
...
!--------------------------------------------------------------------------------------------
      if (indxAIPRS>0) then
         pbuf(indxAIPRS)%fld_ptr(1,1:ncol,1:pver,lchnk,1) = wrk(1:ncol,1:pver)
      endif
