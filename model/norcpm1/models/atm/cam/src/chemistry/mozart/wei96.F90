...
!  get coeff_file  
      unit= getunit()
      write(iulog,*) 'Weimer: getting file ',trim(wei96_file),' unit ',unit
      call getfil( wei96_file, locfn, 0 )
!      
      write(iulog,*) 'Weimer: opening file ',trim(locfn),' unit ',unit	
...
!     READ(udat,900) skip
      write(iulog,*) 'Weimer: reading file ',trim(locfn),' unit ',unit	
...
!
	...
	COMMON/TRANSDAT/CX(9),ST(6),CT(6),AM(3,3,11)
        ...
        real(r8) epoch, th0, ph0, dipole
        COMMON/MFIELD/EPOCH,TH0,PH0,DIPOLE
	DATA EPOCH,TH0,PH0,DIPOLE/1980._r8,11.19_r8,-70.76_r8,.30574_r8/
!
!------------------------------Arguments--------------------------------
!
