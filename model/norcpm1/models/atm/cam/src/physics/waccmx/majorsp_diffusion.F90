...
!-----------------------
  ...
  integer :: ntop_molec                                  ! Top level to which major diffusion
                                                         ! is applied (=1).
  integer :: nbot_molec                                  ! Bottom level to which major diffusion
                                                         ! is applied.
...
!===============================================================================
  subroutine mspd_init()
    ...
    !----------------------------------------------------------------------------------------
    call phys_getopts( ntop_molec_out = ntop_molec, nbot_molec_out = nbot_molec )
...
!---------------------------Local storage-------------------------------
    ...
    ptend%name  = "Major species diffusion"
...
!---------------------------Local storage-------------------------------
    real(r8) :: kboltz                             ! Boltzmann constant (J/K)
    ...
    integer  :: lev0                               ! nbot_molec
    integer  :: lev1                               ! ntop_molec
