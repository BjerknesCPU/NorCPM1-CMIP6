...
#ifdef AERLIFE
   character(len=16), public :: wetflxnam(pcnst)      ! names of surface wet deposition of species
   character(len=16), public :: numbnam(pcnst)      ! names given for number distribution of species
#endif
...
!==============================================================================================
  ...
  subroutine cnst_add (name, mwc, cpc, qminc, &
                       ind, longname, readiv, mixtype, molectype, cam_outfld, fixed_ubc, fixed_ubflx)
!----------------------------------------------------------------------- 
! 
...
#ifdef AERLIFE
       wetflxnam(m)   = 'WD'//cnst_name(m)
       numbnam(m)   = 'N'//cnst_name(m)
#endif
    end do
