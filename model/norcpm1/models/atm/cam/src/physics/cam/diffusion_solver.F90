  ...
  subroutine init_vdiff( kind, ncnst, rair_in, gravit_in, fieldlist_wet, fieldlist_dry, fieldlist_molec, errstring )
    ...
    type(vdiff_selector), intent(out) :: fieldlist_molec ! List of fields to undergo molecular diffusion
    ...
    !---------------------------------------------------------------
    !  For molecular diffusion, initialize fieldlist flags to false 
    !---------------------------------------------------------------
    allocate( fieldlist_molec%fields( 3 + ncnst ) )
    fieldlist_molec%fields(:) = .false.
