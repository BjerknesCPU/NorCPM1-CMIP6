...
!+tht
     .  surflx_atm,        ! surface thermal energy flux, atmosphere
!-tht
     ...
     .  taux_atm,tauy_atm, ! surface stress components (atmosphere +sy 2016/10/11)
...
c
     ...
     .                difmxq,difwgt,sealv,surflx,
!+tht
     .                surflx_atm,
!-tht
     .                surrlx,sswflx,salflx,
     .                brnflx,salrlx,taux,tauy,ustar,ustarb,buoyfl,
     .                taux_atm, tauy_atm,  !(atmosphere +sy 2016/10/12)
     .                twedon,pbrnda,kfpla
c
...
c
      character*120 path,path1,path2,runid
